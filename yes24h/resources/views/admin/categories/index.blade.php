	...
	<main class="app-layout-content">
	    ...
	    <div class="container-fluid p-y-md">
	    	<div class="row" style="margin-bottom: 20px;">
	    		<div class="col-md-12">
	    			<div class="pull-left">
			    		<a href="{{ route('admin.dashboard') }}" class="btn btn-app-blue"><i class="ion-ios-arrow-back"></i> Bảng điều khiển</a>
			    	</div>
			    	<div class="pull-right">
			    		<a href="{{ route('admin.categories.create')}}" class="btn btn-pill btn-app-blue">Thêm danh mục</a>
			    	</div>
	    		</div>
	    	</div>
